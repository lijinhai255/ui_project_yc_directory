...
var WalletModal = ({
  ...
  return /* @__PURE__ */ jsx5("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50", children: /* @__PURE__ */ jsxs4("div", { className: `w-full max-w-2xl mx-4 rounded-lg border ${classes.background} ${classes.border}`, children: [
    ...
    /* @__PURE__ */ jsx5("div", { className: "p-6 max-h-96 overflow-y-auto", children: walletsLoading ? /* @__PURE__ */ jsxs4("div", { className: `text-center ${classes.secondaryText}`, children: [
      ...
      "\u68C0\u6D4B\u94B1\u5305\u4E2D..."
    ] }) : installedWallets.length === 0 ? /* @__PURE__ */ jsx5("div", { className: `text-center ${classes.secondaryText}`, children: "\u6CA1\u6709\u627E\u5230\u5DF2\u5B89\u88C5\u7684\u94B1\u5305\uFF0C\u8BF7\u5B89\u88C5\u94B1\u5305\u6269\u5C55\u7A0B\u5E8F" }) : /* @__PURE__ */ jsx5("div", { className: isGridLayout ? "grid grid-cols-2 gap-4" : "space-y-3", children: installedWallets.map((wallet) => {
      ...
      return /* @__PURE__ */ jsxs4(
        "button",
        {
          ...
          children: [
            ...
            wallet.installed && /* @__PURE__ */ jsx5("div", { className: `text-sm ${classes.secondaryText}`, children: "\u5DF2\u5B89\u88C5" }),
