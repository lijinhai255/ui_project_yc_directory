...
var ICONS = {
  add: async () => (await import("./add-D3FVDIEM.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-BPZXIR2J.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-ORUSYTDS.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-67SWZMET.js")).appStoreSvg,
  apple: async () => (await import("./apple-KOUVWQN6.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-3QGSZIKZ.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-GC6U6P5Z.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-YJWYNW62.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-JOBXBDGU.js")).arrowTopSvg,
  bank: async () => (await import("./bank-COEOZZZN.js")).bankSvg,
  browser: async () => (await import("./browser-3ALKFCLN.js")).browserSvg,
  card: async () => (await import("./card-OXM3P4VK.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-ZU6ZYYRJ.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-EKPSUBNK.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-GSTOPT65.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-OK2SEG2Z.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-CFEL5FNI.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-DAQRQTHG.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-GOMVNDB4.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-MLIZOWXK.js")).clockSvg,
  close: async () => (await import("./close-XUMCDYIU.js")).closeSvg,
  compass: async () => (await import("./compass-BOYZYVM2.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-SGWXXNHR.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-P634EVNO.js")).copySvg,
  cursor: async () => (await import("./cursor-ZNGYS4M5.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-UYLTEQTF.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-NL2E73SY.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-VJIVDJUP.js")).disconnectSvg,
  discord: async () => (await import("./discord-DLSDEA6Z.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-TO2FHSHT.js")).etherscanSvg,
  extension: async () => (await import("./extension-VYZFMN3R.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-XAFIEOM4.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-E47G7445.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-O4SH3K6E.js")).farcasterSvg,
  filters: async () => (await import("./filters-ZF5PHJJR.js")).filtersSvg,
  github: async () => (await import("./github-ULVNCJDX.js")).githubSvg,
  google: async () => (await import("./google-2CNKAKLR.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-JX4GOIAP.js")).helpCircleSvg,
  image: async () => (await import("./image-4BN42747.js")).imageSvg,
  id: async () => (await import("./id-EJBCNHJ3.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-PJGABWKF.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-JMZLH5OZ.js")).lightbulbSvg,
  mail: async () => (await import("./mail-IJ3MOMLX.js")).mailSvg,
  mobile: async () => (await import("./mobile-XZMUDX5T.js")).mobileSvg,
  more: async () => (await import("./more-VITYFUQB.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-LPQFX5IF.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-3R6OPSPQ.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-IKWND26E.js")).offSvg,
  playStore: async () => (await import("./play-store-V2P4TJBN.js")).playStoreSvg,
  plus: async () => (await import("./plus-BYRWUCUI.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-23B3L2SR.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-PVCEP2SF.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-533Y2HQI.js")).refreshSvg,
  search: async () => (await import("./search-FAYBGU76.js")).searchSvg,
  send: async () => (await import("./send-NWDNIOWR.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-E3JJ3LPP.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-2BMMVBQM.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-QFA5FCTC.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-SADNXUQA.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-CTLFYCTH.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-5YLVFUP2.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-AJ6A533Q.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-LHZ6B5TR.js")).twitchSvg,
  twitter: async () => (await import("./x-DCZN76GE.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-GFRXZPNS.js")).twitterIconSvg,
  verify: async () => (await import("./verify-HVTCXQYK.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-4TZ7ERR6.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-EHMGXPIP.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-UAEZI3RQ.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-UAEZI3RQ.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-UAEZI3RQ.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-74YFLVTK.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-2RSRH3X5.js")).warningCircleSvg,
  x: async () => (await import("./x-DCZN76GE.js")).xSvg,
  info: async () => (await import("./info-TDIH3B5T.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-F3BIRKXN.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-3S22JFLY.js")).reownSvg
};
...
lit-html/development/directive-helpers.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-FF46FZ7Y.js.map
